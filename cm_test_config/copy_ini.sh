...
do
    ...
    do
            cp /home/cm/projects/ann/SPTAG/buildconfig.ini /home/cm/projects/ann/SPTAG/cm_test_config/query_${i}_${j}
            ...
            -e '15a\GenerateTruth=true' \
            "/home/cm/projects/ann/SPTAG/cm_test_config/query_${i}_${j}"
    done
done
